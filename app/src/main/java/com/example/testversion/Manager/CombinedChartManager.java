...
//        mCombinedChart.animateX(2000); // 立即执行的动画,x轴
    ...
    public void setXAxis(final List<String> xAxisValues) {
        ...
        xAxis.setGranularity(1f);//设置x轴的颗粒度
    ...
    public void showCombinedChart(List<String> xAxisValues, List<Float> barChartY, List<Float> lineChartY, String barName,
                                  String lineName, int barColor, int lineColor) {
        initChart();
    ...
    public void showCombinedChart(List<String> xAxisValues, List<List<Float>> barChartYs, List<List<Float>> lineChartYs,
    ...
    /**
     * 显示混合图(柱状图+折线图)
     * @param xAxisValues:x轴值
     * @param barChartYs 柱状图Y值
     ...
     * @param lineColor 折线图颜色
     */
    public void showCombinedChart(List<String> xAxisValues, List<List<Float>> barChartYs, List<Float> lineChartY,
                                  List<String> barNames,  String lineName, List<Integer> barColors, int lineColor) {
        initChart();
        setXAxis(xAxisValues);
