...
public class OpenFileDialog {
    ...
    static final public String sRoot = "/";  //	根目录图标的索引为sRoot;
    static final public String sParent = ".."; //父目录的索引为sParent;
    static final public String sFolder = "."; //文件夹的索引为sFolder;
    static final public String sEmpty = ""; //默认图标的索引为sEmpty;
     ...
     * @param context 上下文
     * @param title 对话框标题
     * @param callback 一个传递Bundle参数的回调接口
     * @param suffix 需要选择的文件后缀，比如需要选择wav、mp3文件的时候设置为".wav;.mp3;"，注意最后需要一个分号(;)
     * @param images 用来根据后缀显示的图标资源ID。
     * @return 创建的对话框
     */
    ...
    static class FileSelectView extends ListView implements AdapterView.OnItemClickListener {
        ...
        private int refreshFileList()
        {
            ...
            SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.openfiledialog_item, new String[]{"img", "name", "path"}, new int[]{R.id.item_img, R.id.item_name, R.id.item_path});
