...
import com.example.testversion.jdsp.windows.Rectangular;
import com.example.testversion.jdsp.windows._Window;
...
public class InverseShortTimeFourier {
    private final com.example.testversion.jdsp.transform._Fourier[] signal;
     ...
     */
    public InverseShortTimeFourier(com.example.testversion.jdsp.transform._Fourier[] signal, int frameLength, int overlap, _Window window) {
        if (signal == null) {
     ...
     * @param overlap       number of overlap frames used in the STFT
     */
    public InverseShortTimeFourier(com.example.testversion.jdsp.transform._Fourier[] signal, int frameLength, int overlap) {
     ...
     *                          the signal was zero-padded in the STFT
     */
    public InverseShortTimeFourier(com.example.testversion.jdsp.transform._Fourier[] signal, int frameLength) {
     ...
     * @param signal        STFT signal to be converted
     */
    public InverseShortTimeFourier(com.example.testversion.jdsp.transform._Fourier[] signal) {
     ...
     * @throws ExceptionInInitializerError if called before executing istft() method
