...
public class ShortTimeFourier {
    ...
    private com.example.testversion.jdsp.transform._Fourier[] output = null;
    ...
    public void transform() {
        ...
        this.output = new com.example.testversion.jdsp.transform._Fourier[cols];
        ...
        for (int m = 0; R < cols; m += (frameLength - overlap)) {
            ...
            com.example.testversion.jdsp.transform._Fourier dft;
            if (frame.length > 200) {
    ...
    public com.example.testversion.jdsp.transform._Fourier[] getOutput() {
        checkOutput();
        return output;
    }
