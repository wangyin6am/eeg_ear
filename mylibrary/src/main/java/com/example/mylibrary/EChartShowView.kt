...
import com.example.mylibrary.utils.DensityUtil.dip2px
...
class EChartShowView(context: Context, attrs: AttributeSet) : View(context, attrs) {

    private var SHOW_MODEL = 0
    private val SHOW_MODEL_ALL = 0x00
